...
import { Home, Compass, MessageSquare, Cpu, Clipboard, Zap, LogOut, ShieldCheck, Award, Shield } from 'lucide-react';
    ...
    <div className="app-container">
      ...
      <aside className="sidebar">
        ...
        <nav className="nav-menu">
          ...
          >
            <Shield className="nav-item-icon" /> Security Lab
          </li>
          <li 
        ...
        <header className="top-header">
          <div>
            <h1 style={{ fontSize: '1.75rem', fontFamily: 'var(--font-heading)' }}>
              ...
              {currentTab === 'security' && "Security & Cryptography Lab"}
            ...
            <span className="header-title-desc">
              ...
              {currentTab === 'security' && "Perform HTTP headers audits and dynamic cryptographic hash analyses."}
